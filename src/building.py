...
class Building(BACPypesApplicationMixin):
    ...
    def generate_energy_report(self, simulation_results):
        ...
        for result in simulation_results:
            ...
            for ahu_name, ahu in self.air_handling_units.items():
                ...
                equipment_energy[ahu_name] += (
                    ahu_energy["cooling"] + ahu_energy["heating"] + ahu_energy["fan"]
                )
    ...
    def get_process_variables(self):
        ...
        variables = {
            ...
            "equipment_count": {"ahu": len(self.air_handling_units), "zones": len(self.zones)},
    ...
    def get_process_variables_metadata(cls):
        ...
        return {
            "name": {"type": str, "label": "Building Name", "description": "Name of the building"},
            "location": {
                "type": str,
                "label": "Location",
