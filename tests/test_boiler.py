...
class TestBoiler(unittest.TestCase):
    ...
    def test_electric_boiler_update_load(self):
        ...
        self.assertAlmostEqual(self.electric_boiler.current_efficiency, 
    ...
    def test_capacity_limits(self):
        ...
        self.assertEqual(self.electric_boiler.current_load, 
    ...
    def test_efficiency_vs_return_temp(self):
        ...
        return_temps = [90, 120, 140, 160]  # Using lower temp to ensure condensing benefit is significant
        efficiencies = []
    ...
    def test_fuel_consumption(self):
        ...
        # Consumption should relate to load and efficiency
        expected_kwh = (self.electric_boiler.current_load * 0.293) / self.electric_boiler.current_efficiency
    ...
    def test_energy_calculations(self):
        ...
        expected_kwh = (750 * 0.293) / self.electric_boiler.current_efficiency * 1  # 750 MBH * conversion to kW * 1 hour
    ...
    def test_boiler_cycling(self):
        ...
        self.assertLessEqual(self.gas_boiler.cycles_in_current_hour, 
                            self.gas_boiler.cycles_per_hour_limit)
    ...
    def test_get_process_variables(self):
        ...
        essential_vars = [
            "name", "fuel_type", "capacity", "current_load", "load_ratio",
            "current_efficiency", "entering_water_temp", "leaving_water_temp",
            "hot_water_flow", "design_hot_water_flow", "is_on", "ambient_temp"
        ]
