...
class TestBuilding(unittest.TestCase):
    ...
    def test_update_equipment(self):
        ...
        zone_temps = {"Office1": 74, "Office2": 68}
    ...
    def test_simulation_with_weather_data(self):
        ...
        weather_data = [
            {
                "time": datetime(2023, 7, 15, 12, 0),
                "temperature": 85,
                "humidity": 60,
                "solar_ghi": 800,
            },
            {
                "time": datetime(2023, 7, 15, 12, 15),
                "temperature": 86,
                "humidity": 58,
                "solar_ghi": 820,
            },
            {
                "time": datetime(2023, 7, 15, 12, 30),
                "temperature": 87,
                "humidity": 57,
                "solar_ghi": 830,
            },
            {
                "time": datetime(2023, 7, 15, 12, 45),
                "temperature": 87,
                "humidity": 56,
                "solar_ghi": 840,
            },
            {
                "time": datetime(2023, 7, 15, 13, 0),
                "temperature": 88,
                "humidity": 55,
                "solar_ghi": 850,
            },
        ...
        results = self.building.run_simulation(
            weather_data=weather_data, interval_minutes=15, initial_zone_temps={"Office": 74}
        )
    ...
    def test_get_process_variables(self):
        ...
        self.building.set_outdoor_conditions(
            temperature=85, humidity=60, solar_ghi=800, wind_speed=5, wind_direction=180
        )
