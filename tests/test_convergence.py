...
class TestTemperatureConvergence(unittest.TestCase):
    ...
    def test_cooling_convergence(self):
        ...
        # Expected: zone_temp_setpoint + (deadband / 2) = 73
        final_temp = temps[-1]
    ...
    def test_heating_convergence(self):
        ...
        # Expected: zone_temp_setpoint - (deadband / 2) = 71
        final_temp = temps[-1]
    ...
    def test_cycling_outdoor_temps(self):
        ...
        # Max allowed deviation: deadband + 3 = 5 degrees
    ...
    def test_extreme_conditions(self):
        ...
        self.assertTrue(min(temps_cold) >= 60, f"Temperature dropped too low: {min(temps_cold)}°F")
        self.assertTrue(max(temps_hot) <= 90, f"Temperature rose too high: {max(temps_hot)}°F")
