...
class TestCoolingTower(unittest.TestCase):
    ...
    def test_update_load(self):
        ...
        self.assertLess(self.cooling_tower.leaving_water_temp, self.cooling_tower.entering_water_temp)
    ...
    def test_get_process_variables(self):
        ...
        essential_vars = [
            "name", "capacity", "current_load", "load_ratio", 
            "design_approach", "current_approach", "design_range", "current_range",
            "entering_water_temp", "leaving_water_temp", "current_wet_bulb",
            "water_flow", "fan_speed", "current_fan_power", "efficiency",
        ...
        self.assertAlmostEqual(variables["current_approach"], self.cooling_tower.calculate_approach())
        ...
        self.assertAlmostEqual(variables["current_fan_power"], self.cooling_tower.calculate_power_consumption())
        self.assertAlmostEqual(variables["water_consumption_gph"], self.cooling_tower.calculate_water_consumption())
    ...
    def test_get_process_variables_metadata(self):
        ...
        essential_vars = [
            "name", "capacity", "current_load", "entering_water_temp", "leaving_water_temp", 
            "current_wet_bulb", "fan_speed", "current_fan_power", "efficiency", "water_consumption_gph"
        ]
