...
class TestChiller(unittest.TestCase):
    ...
    def test_capacity_limits(self):
        ...
        self.assertEqual(
            self.air_cooled_chiller.current_load,
    ...
    def test_power_consumption(self):
        ...
        self.assertAlmostEqual(
            water_cooled_power,
            (self.water_cooled_chiller.current_load * 3.517)
            / self.water_cooled_chiller.current_cop,
            delta=1,
        )
    ...
    def test_get_process_variables(self):
        ...
        self.assertEqual(
            water_cooled_vars["entering_chilled_water_temp"],
            self.water_cooled_chiller.entering_chilled_water_temp,
        )
        self.assertEqual(
            water_cooled_vars["leaving_chilled_water_temp"],
            self.water_cooled_chiller.leaving_chilled_water_temp,
        )
