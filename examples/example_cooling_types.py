...
def main():
    ...
    for temp in outdoor_temps:
        ...
        print(
            f"Chilled Water AHU: Cooling={chw_cooling_energy[-1]:.1f} kBTU/hr, Flow={chw_flows[-1]:.1f} GPM"
        )
        print(
            f"DX AHU: Cooling={dx_cooling_energy[-1]:.1f} kBTU/hr, Stages={dx_stages[-1]}/{dx_ahu.compressor_stages}"
        )
